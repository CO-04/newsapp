...
SECRET_KEY = config(
    'SECRET_KEY',
    default=(
        'django-insecure-i=(redgy^1p6_0cbnqo)'
        'w4oyiq)i_1hk52e#=+5fof4!1&fq17'
    ),
)
...
#
# Production / development: MariaDB via mysqlclient.
# Test runner: falls back to SQLite in-memory so tests need no DB server.
...
if 'test' in sys.argv:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME':     config('DB_NAME',     default='newsapp_db'),
            'USER':     config('DB_USER',     default='newsapp_user'),
...
DEFAULT_FROM_EMAIL = config(
    'DEFAULT_FROM_EMAIL', default='noreply@newsapp.local',
)
